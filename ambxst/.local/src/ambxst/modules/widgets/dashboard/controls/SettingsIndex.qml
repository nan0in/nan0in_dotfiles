...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        { label: "GTK Theme", keywords: "gtk application theming appearance", section: 4, subSection: "applications", subLabel: "Theme > Applications", icon: Icons.paintBrush, isIcon: true },
        { label: "Qt Theme", keywords: "qt application theming appearance", section: 4, subSection: "applications", subLabel: "Theme > Applications", icon: Icons.paintBrush, isIcon: true },
        { label: "Cursor Theme", keywords: "cursor mouse pointer theme size", section: 4, subSection: "applications", subLabel: "Theme > Applications", icon: Icons.mousePointer, isIcon: true },
        { label: "Icon Theme", keywords: "icons theme glyph", section: 4, subSection: "applications", subLabel: "Theme > Applications", icon: Icons.appWindow, isIcon: true },
